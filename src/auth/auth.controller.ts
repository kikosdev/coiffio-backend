...
export class AuthController {
  ...
  async loginPin(
    ...
    // POS token delivered in response body — desktop stores it via sessionStorage adapter.
    // No cookie: desktop kiosk uses Authorization: Bearer header, not cookies.
  ...
  /** Alias route for mobile — POST /auth/register/client */
  ...
  /** Owner only — creates a staff account (users + Staff profile). */
  @Post('staff')
